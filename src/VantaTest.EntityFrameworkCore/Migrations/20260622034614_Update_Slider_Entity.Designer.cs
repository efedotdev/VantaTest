...
{
    [DbContext(typeof(VantaTestDbContext))]
    [Migration("20260622034614_Update_Slider_Entity")]
    partial class Update_Slider_Entity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VantaTest.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("VantaTest.Foods.Food", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VantaTest.Headers.Header", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppHeaders", (string)null);
                });

            modelBuilder.Entity("VantaTest.Sliders.Slider", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppSliders", (string)null);
                });
            ...
            modelBuilder.Entity("VantaTest.Foods.Food", b =>
                {
                    b.HasOne("VantaTest.Categories.Category", "Category")
                        .WithMany()
